...
const CreateTask = () => {
   ...
   const [description, setDescription] = useState("");
    ...
    const handleSubmit=(e)=>{
        e.preventDefault();
        console.log({title,description,date,assign,category});
    }
        ...
        <form onSubmit={handleSubmit} className='flex flex-wrap w-full items-start justify-between'>
            <div className='w-1/2'>
                ...
                <div>
                    ...
                    <input value={assign} onChange={e=>setAssign(e.target.value)} className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='employee name' />
                </div>
                <div>
